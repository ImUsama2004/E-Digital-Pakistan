...
export default function ExpertCard({ name, role, specialty, skills, previousCompany, imageUrl }: ExpertProps) {
  return (
    <div className="group flex flex-col bg-white border border-gray-100 rounded-sm overflow-hidden shadow-sm hover:shadow-xl hover:border-[#00d37f]/30 transition-all h-full cursor-pointer w-full">
      ...
      <div className="relative aspect-4/3 w-full bg-[#dbe2e8] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 p-2">
            <div className="w-4 h-4 bg-[#00d37f] flex items-center justify-center text-[8px] text-white rotate-45 shadow-sm">✦</div>
        </div>
      </div>
      ...
      <div className="p-4 md:p-6 flex flex-col flex-1">
        ...
        <div className="flex items-center gap-1 text-[11px] md:text-[13px] text-[#00bc71] font-medium mb-1">
            <span className="w-3 h-3 md:w-3.5 md:h-3.5 bg-[#00bc71] rounded-full flex items-center justify-center text-white text-[7px] md:text-[8px]">✓</span>
        ...
        <div className="mb-6">
            <p className="text-[9px] md:text-[10px] uppercase tracking-widest text-gray-400 font-bold mb-3">Expertise</p>
            <div className="flex flex-wrap gap-1.5 md:gap-2">
                {skills.slice(0, 4).map(skill => ( // Limited to 4 on small screens to prevent overflow
                    <span 
                      key={skill} 
        ...
        <div className="mt-auto pt-4 border-t border-gray-50 flex flex-col">
          <p className="text-gray-400 text-[9px] md:text-[10px] uppercase font-bold tracking-widest mb-2">Previously at</p>
