...
const steps: ProcessStep[] = [
  { id: 'requirements', number: '01', title: 'Requirements Gathering', description: "Share your vision with us and we can take your idea, mature it and turn it into a successful mobile app.", iconType: 'list' },
  { id: 'validation', number: '02', title: 'Idea Validation', highlightText: "Ideas are great when they’re ambitious but often end up in loss if they're not validated.", description: "We work hard to validate your idea, provide a thorough summary in terms of the earning model and time required.", iconType: 'lightbulb' },
  { id: 'brainstorming', number: '03', title: 'Brain Storming', description: "We dive deep into user personas and market trends to ensure your app stands out with creative, unique solutions.", iconType: 'brain' },
  { id: 'scope', number: '04', title: 'Scope Documentation', description: "We outline every feature and integration into a comprehensive blueprint for your entire project.", iconType: 'scope' },
  { id: 'wireframing', number: '05', title: 'Wire Framing', description: "We build low-fidelity skeletons of your app to perfect the user journey and functionality.", iconType: 'wireframe' },
  { id: 'uiux', number: '06', title: 'UI/UX Design', description: "We blend aesthetics with usability to create intuitive, engaging, and brand-reflective designs.", iconType: 'uiux' },
  { id: 'programming', number: '07', title: 'Programming', description: "Our developers build a robust, scalable engine using clean code to power your application.", iconType: 'code' },
...
const IconSelector = ({ type }: { type: string }) => {
  ...
  switch (type) {
    ...
    case 'wireframe': return (<svg className={commonSize} viewBox="0 0 200 200" fill="none"><rect x="60" y="50" width="80" height="100" rx="10" stroke="#94A3B8" strokeWidth="4" strokeDasharray="8 8"/><path d="M60 100h80M100 50v100" stroke="#CBD5E1" strokeWidth="2"/><circle cx="100" cy="100" r="15" fill="#10B981" fillOpacity="0.2" stroke="#10B981" strokeWidth="2"/></svg>);
    case 'uiux': return (<svg className={commonSize} viewBox="0 0 200 200" fill="none"><circle cx="80" cy="80" r="40" fill="#F43F5E" fillOpacity="0.6"/><circle cx="120" cy="80" r="40" fill="#3B82F6" fillOpacity="0.6"/><circle cx="100" cy="120" r="40" fill="#FBBF24" fillOpacity="0.6"/></svg>);
    case 'code': return (<svg className={commonSize} viewBox="0 0 200 200" fill="none"><path d="M70 80l-20 20 20 20M130 80l20 20-20 20M110 60l-20 80" stroke="#1e293b" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"/></svg>);
    case 'qa': return (<svg className={commonSize} viewBox="0 0 200 200" fill="none"><circle cx="90" cy="90" r="40" stroke="#1a8fff" strokeWidth="8"/><path d="M120 120l30 30" stroke="#1a8fff" strokeWidth="12" strokeLinecap="round"/><path d="M80 80l20 20m0-20l-20 20" stroke="#f43f5e" strokeWidth="4" strokeLinecap="round"/></svg>);
    default: return null;
  }
};
